...
class Book(models.Model):
    title = models.CharField(
        max_length=100, verbose_name="Book Title", help_text="Укажите название книги"
    )
    ...
    genre = models.CharField(
        verbose_name="Book Genre", help_text="Укажите жанр книги", blank=True, null=True
    )
...
class TakeBook(models.Model):
    ...
    return_date = models.DateField(
        verbose_name="Дата возврата книги", blank=True, null=True
    )
